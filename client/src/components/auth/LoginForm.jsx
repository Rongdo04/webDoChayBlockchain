...
import Toast from "../../user/components/Toast"; // ✅ Thêm Toast UI-only
...
const LoginForm = () => {
  ...
  // ✅ Delay nhẹ để user thấy Toast trước khi điều hướng
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ Dùng Toast UI-only thay cho toast.success
      showToast(
        "success",
      ...
      // ✅ Điều hướng sau 600ms để Toast kịp hiện
