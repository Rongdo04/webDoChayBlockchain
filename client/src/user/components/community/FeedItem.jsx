    ...
    >
      <div className="flex items-start gap-4">
        {userAvatar ? (
          ...
          <div className="w-12 h-12 rounded-full bg-emerald-900/10 flex items-center justify-center ring-2 ring-emerald-900/10">
            <span className="text-emerald-900/70 font-semibold text-sm">
